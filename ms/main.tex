...
(default): simplified Betts--Miller (SBM; \citealt{frierson2007}), relaxing temperature to
the moist adiabat and humidity to a reference RH (0.7); four other schemes are
selectable. Surface turbulent fluxes: simplified Monin--Obukhov \citep{frierson2006}
