...
Calculations by \citet{kasting1993} suggested that previous models lacked the negative stabilizing feedback on Earth's climate that arises from the carbonate-silicate cycle, in which the long-term abundance of atmospheric CO2 is regulated by temperature-dependent weathering with crustal rocks \citep{walker1981negative}. The \citet{kasting1993} model gave a conservative estimate of the CHZ as 0.95--1.15\,AU, falling between the optimistic limits of \citet{Dole2007HabitableMan} and the narrow limits of \citet{hart1979}. \citet{kasting1993} also noted that the CHZ is wider for K- and M-type stars due to their slower main sequence evolution; however, later type stars are also prone to synchronous rotation. 



These results continue to have important impliat




The key insight that stabalizing planetary feedbacks could enable habitable con
...
Updates to the \citet{kasting1993} model by \citet{kopparapu}
...
%% TODO
%% [New first paragraph -- citation scaffolding only; narrative to be written.]
[HZ terminology: the ``habitable zone'' \citep{hart1979, kasting1993} succeeded
the earlier ``biosphere'' \citep{suess1875}, ``ecosystem'' \citep{tansley1935},
and ``ecosphere'' \citep{cole1958}.]
