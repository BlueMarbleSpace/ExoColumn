...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.8\textwidth]{reference/earth/conv_sensitivity.pdf}
\caption{}
\label{fig:conv_sensitivity}
\end{figure}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.7\textwidth]{reference/habitablezone/hz_polyfit.pdf}
\caption{}
\label{fig:hz_polyfit}
\end{figure}
